...
function rechercherVainqueur(pions, joueurs, tour) {
    if (
        ...
        pions[0].style.backgroundColor = "#0c3c8a";
        pions[1].style.backgroundColor = "#0c3c8a";
        pions[2].style.backgroundColor = "#0c3c8a";
        return true;
    }
    ...
    if (
        ...
        pions[3].style.backgroundColor = "#0c3c8a";
        pions[4].style.backgroundColor = "#0c3c8a";
        pions[5].style.backgroundColor = "#0c3c8a";
        return true;
    }
    ...
    if (
        ...
        pions[6].style.backgroundColor = "#0c3c8a";
        pions[7].style.backgroundColor = "#0c3c8a";
        pions[8].style.backgroundColor = "#0c3c8a";
        return true;
    }
...
function main() {
    ...
    var afficheur = new Afficheur(document.querySelector("#text"));
